...
public class UpdatePatientRequest extends UpdateUserRequest {
    ...
    public UpdatePatientRequest(String firstName, String lastName, String patronymic, String oldPassword, String newPassword, String email, String address, String phone) {
